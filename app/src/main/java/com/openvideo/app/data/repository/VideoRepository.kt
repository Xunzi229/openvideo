package com.openvideo.app.data.repository

import android.app.PendingIntent
import com.openvideo.app.core.metadata.EpisodeMatchConfidence
import com.openvideo.app.core.metadata.EpisodeNameParser
import com.openvideo.app.core.metadata.LocalArtworkCandidateScanner
import com.openvideo.app.core.metadata.LocalArtworkFinder
import com.openvideo.app.core.mediaid.MediaFingerprint
import com.openvideo.app.core.mediaid.MediaFingerprintPolicy
import com.openvideo.app.core.mediaid.MediaIdentityCandidate
import com.openvideo.app.core.mediaid.MediaIdentityMatchDecision
import com.openvideo.app.core.mediaid.MediaIdentityMatcher
import com.openvideo.app.core.mediaid.MediaPathNormalizer
import com.openvideo.app.core.network.NetworkRecentUrlPolicy
import com.openvideo.app.core.network.WebDavConnectionPolicy
import com.openvideo.app.core.prefs.WebDavCredentialStore
import com.openvideo.app.data.local.EpisodeEntity
...
import com.openvideo.app.data.local.MediaIdentityEntity
import com.openvideo.app.data.local.MediaPathHistoryEntity
import com.openvideo.app.data.local.MediaSourceDao
import com.openvideo.app.data.local.MediaSourceEntity
import com.openvideo.app.data.local.NetworkRecentItemDao
import com.openvideo.app.data.local.NetworkRecentItemEntity
import com.openvideo.app.data.local.PlaylistDao
import com.openvideo.app.data.local.PlaylistEntity
...
import com.openvideo.app.data.local.SeriesEpisodePlaybackEntity
import com.openvideo.app.data.model.VideoItem
import com.openvideo.app.data.scanner.VideoDeleteResult
import com.openvideo.app.data.scanner.VideoScanOutcome
import com.openvideo.app.data.scanner.VideoScanner
import com.openvideo.app.ui.history.HistoryCleanupPolicy
