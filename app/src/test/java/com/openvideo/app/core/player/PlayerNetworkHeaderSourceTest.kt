...
class PlayerNetworkHeaderSourceTest {
    ...
    fun playerManagerUsesHttpDataSourceWithOpenVideoUserAgent() {
        ...
        assertTrue(source.contains("import com.openvideo.app.core.network.NetworkPlaybackHeaderPolicy"))
    ...
    private fun playerManagerSource(): String = loadText(
        Paths.get("src", "main", "java", "com", "openvideo", "app", "core", "player", "PlayerManager.kt")
    )
