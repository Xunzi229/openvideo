...
class CrashReportOutboxSourceTest {
    ...
    fun reportsArePersistedBeforeSingleThreadedDeliveryAndDeletedOnlyOnSuccess() {
        val path = sequenceOf(
            Paths.get("src/main/java/com/openvideo/app/core/diagnostics/CrashReportOutbox.kt"),
            Paths.get("app/src/main/java/com/openvideo/app/core/diagnostics/CrashReportOutbox.kt")
        ).first(Files::exists)
