...
class PlayerDualSubtitleStateSourceTest {
    ...
    fun playerViewModelCanSetAndToggleSecondarySubtitleTrack() {
        ...
        assertTrue(source.contains("import com.openvideo.app.core.subtitle.SecondarySubtitle"))
    ...
    private fun playerViewModelSource() =
        sequenceOf(
            Paths.get("src", "main", "java", "com", "openvideo", "app", "ui", "player", "PlayerViewModel.kt"),
            Paths.get("app", "src", "main", "java", "com", "openvideo", "app", "ui", "player", "PlayerViewModel.kt")
        ).first(Files::exists)

    private fun playerSubtitleSettingsSheetSource() =
        sequenceOf(
            Paths.get("src", "main", "java", "com", "openvideo", "app", "ui", "player", "PlayerSubtitleSettingsSheet.kt"),
            Paths.get("app", "src", "main", "java", "com", "openvideo", "app", "ui", "player", "PlayerSubtitleSettingsSheet.kt")
        ).first(Files::exists)
