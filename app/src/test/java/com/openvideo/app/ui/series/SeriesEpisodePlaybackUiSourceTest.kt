...
class SeriesEpisodePlaybackUiSourceTest {
    ...
    fun uiStateMapsPlayableEpisodeFieldsIntoVideoItem() {
        ...
        assertTrue(source.contains("import com.openvideo.app.core.media.LocalMediaUriPolicy"))
        assertTrue(source.contains("import com.openvideo.app.data.local.SeriesEpisodePlaybackEntity"))
        assertTrue(source.contains("import com.openvideo.app.data.model.VideoItem"))
    ...
    private fun sourceFile(name: String): Path? {
        val relativePath = Paths.get("src", "main", "java", "com", "openvideo", "app", "ui", "series", name)
