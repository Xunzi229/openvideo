...
class AppSettingsApplierTest {
    ...
    fun settingsViewModelAppliesOnlyTheConfigurationThatChanged() {
        val path = sequenceOf(
            Paths.get("app/src/main/java/com/openvideo/app/ui/settings/SettingsViewModel.kt"),
            Paths.get("src/main/java/com/openvideo/app/ui/settings/SettingsViewModel.kt")
        ).first(Files::exists)
