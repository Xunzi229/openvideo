...
class TvHomeSourceTest {
    ...
    fun mainActivityLoadsTvHomeAndHidesPhoneBottomNavInTvMode() {
        ...
        assertTrue(source.contains("import com.openvideo.app.ui.tv.TvHomeFragment"))
    ...
    fun tvHomeFragmentRoutesLargeCardsToExistingScreens() {
        val source = loadText(
            Paths.get("src", "main", "java", "com", "openvideo", "app", "ui", "tv", "TvHomeFragment.kt")
        )
    ...
    fun tvHomeSeriesCardReusesSeriesPosterCoverWithFallback() {
        ...
        assertTrue(source.contains("import com.openvideo.app.ui.series.SeriesListViewModel"))
    ...
    fun tvHomeContinueCardReusesRecentVideoThumbnailWithFallback() {
        ...
        assertTrue(source.contains("import com.openvideo.app.ui.home.HomeViewModel"))
    ...
    fun tvHomeContinueCardOpensExistingRecentCategory() {
        ...
        assertTrue(source.contains("import com.openvideo.app.ui.home.HomeCategory"))
    ...
    fun tvHomeSettingsCardShowsDefaultPlaybackSummary() {
        ...
        assertTrue(source.contains("import com.openvideo.app.ui.player.PlayerAspectRatioOptions"))
        assertTrue(source.contains("import com.openvideo.app.ui.settings.SettingsViewModel"))
    ...
    fun tvHomeExplainsMediaPermissionBeforeLocalLibraryScan() {
        ...
        assertTrue(source.contains("import androidx.core.view.isVisible"))
        assertTrue(source.contains("import com.openvideo.app.ui.home.MediaLibraryPermissionPolicy"))
