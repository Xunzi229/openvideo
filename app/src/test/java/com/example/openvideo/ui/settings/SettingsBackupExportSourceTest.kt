...
class SettingsBackupExportSourceTest {
    ...
    fun settingsFragmentKeepsBackupInfrastructureBehindHiddenUiSwitch() {
        ...
        assertTrue(fragment.contains("val appContext = requireContext().applicationContext"))
        assertTrue(fragment.contains("viewModel.readAndImportSettings(appContext, uri)"))
